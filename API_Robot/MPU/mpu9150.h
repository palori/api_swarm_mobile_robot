...
// data from imu
extern int16_t imuAcc[3];
extern int16_t imuGyro[3];
extern int16_t imuMag[3];
extern int32_t offsetGyro[3];
extern bool    gyroOffsetDone;
extern const float gyroScaleFac; // from raw measurement to degree/sec
extern const float accScaleFac;  // from raw measurement to m/s2
